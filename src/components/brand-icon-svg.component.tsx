...
const BrandIconSvg = () => {
  return (
    <SvgIcon sx={{ mr: 1 }}>
      <svg width="800px" height="800px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" fill="#000000">
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <path d="M33.2 45.1c-3.1-2.4-8-2.4-11.1 0c-3.1 2.4-3.1 6.2 0 8.6s8 2.4 11.1 0c3-2.4 3-6.3 0-8.6" fill="#1b96f3"/>
          <path d="M19.6 33.6c-3.4-1.6-8-.6-10.4 2.3c-2.4 2.9-1.6 6.5 1.8 8.1c3.4 1.6 8 .6 10.4-2.3c2.4-2.9 1.6-6.5-1.8-8.1" fill="#fef60b"/>
          ...
          <path d="M44.7 9.7c-2.2-1.8-5.9-2.2-8.5-1c-2.5 1.2-2.8 3.7-.6 5.5c2.2 1.8 5.9 2.2 8.5 1c2.5-1.3 2.7-3.7.6-5.5" fill="#8845b5"/>
